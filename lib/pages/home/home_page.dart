...
import 'package:food_delivery_flutter/pages/account/account_page.dart';
...
Widget build(BuildContext context) {
  return GetBuilder<AuthController>(
    builder: (controller) {
      bool isLoggedIn = controller.hasLogedIn();
      return Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: [
            ...
            // Conditionally show the "Account" tab based on isLoggedIn
            if (isLoggedIn)
              BottomNavigationBarItem(
