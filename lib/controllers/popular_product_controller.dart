...
class PopularProductController extends GetxController {
 ...
 Future<void> searchProductsByLocation(String location) async {
    await getPopularProductList(); // Fetch products first
    _popularProductList = _popularProductList.where((product) => product.location.toLowerCase().contains(location.toLowerCase())).toList();
    update();
  }
